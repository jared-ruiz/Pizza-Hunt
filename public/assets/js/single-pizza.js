...
//retrieves the id from the url for a get request
function getPizza() {
  //get id of pizza
  ...
  .catch(err => {
    ...
    //window history api takes user back a page 
    window.history.back();
  })
}
...
function handleNewCommentSubmit(event) {
  ...
  //make post request to add new comment into the comment array within pizza model
...
//make a put request to add the reply to the reply array within the comment model
